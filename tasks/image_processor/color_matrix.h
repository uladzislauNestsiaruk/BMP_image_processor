...
public:
    ...
    const uint32_t Offset(uint32_t y, uint32_t x) const {return y * (width_ * sizeof(Pixel) + padding_) + x * sizeof(Pixel);}

    uint8_t& GetPixelMatrix(){return *matrix_;}
